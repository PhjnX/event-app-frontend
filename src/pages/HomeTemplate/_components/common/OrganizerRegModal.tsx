...
const OrganizerRegModal: React.FC<OrganizerRegModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isAuthenticated) {
      toast.info(
        "Bạn cần Đăng nhập hoặc Tạo tài khoản để đăng ký làm Đối tác!",
        { theme: "dark" }
      );
      return;
    }
                    ...
                    >
                      <div className="mb-10">
                        <h2 className="text-4xl md:text-5xl font-noto font-medium text-white mb-4 leading-none tracking-tight">
                          TRỞ THÀNH{" "}
                          <span className="text-[#D8C97B]">ĐỐI TÁC WEBIE</span>
                        </h2>
                        <p className="text-zinc-500 text-lg font-light max-w-lg">
                          Kết nối với mạng lưới tổ chức sự kiện chuyên nghiệp và
